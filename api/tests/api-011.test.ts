/**
 * Unit tests for GET /api/experiences/rollup (API-011).
 *
...
describe('GET /api/experiences/rollup — unit', () => {
  it('returns 401 when no session cookie is provided', async () => {
    ...
    try {
      const res = await app.inject({
        method: 'GET',
        url: '/api/experiences/rollup?owner_user_id=user-123',
      });
