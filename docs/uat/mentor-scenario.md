...
|------|--------|-----------------|-----------|
| 1 | In the **mentor window**, navigate to `http://localhost:6041/sign-in`. | The **Sign in** page loads with an **Email** field, a **Password** field, and a **Sign in** button. | |
...
| Step | Action | Expected result | Pass/Fail |
|------|--------|-----------------|-----------|
| 13 | In the **applicant window** (incognito / private), navigate to `http://localhost:6041/sign-in`. | The **Sign in** page loads. | |
