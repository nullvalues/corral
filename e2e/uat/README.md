...
2. Waits for the API health endpoint (`http://localhost:6040/api/health`) to
...
| `ALLOWED_ORIGIN` | `http://localhost:6041` | API CORS origin |
| `MFA_ENABLED` | `true` | Set in .env.local |
| `PORT` | `6040` | API listen port |
...
| `API_BASE` | `http://localhost:6040` | Passed to seed:uat |
| `BASE_URL` | `http://localhost:6041` | Playwright base URL |
